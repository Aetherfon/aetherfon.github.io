...
let imprintTextWords = [
  ...
  "Moniek Wiese", "\n", "\n",
  "Schriften", "\n",
  "Freight ", "Neo ", "von  ", "Phil’s ", "Fonts, ", "Adobe ", "Fonts ", "\n", "\n",
  "BHV ", "Display ", "von ", "La ", "Bolde ", "Vita. ", "\n",
  "www.laboldevita.com ", "\n",
  "Vielen ", "Dank ", "an ", "Fabian ", "Dornhecker. ",
  ...
  "Europäischen ", "Kommission ", "unter ", "http://ec.europa.eu/odr?tid=321260393 ", "zu ", "richten. ", "Die ", "dafür ", 
  ...
  "und ", "aktuelle ", "Informationen ", "bereitzustellen. ", "Laut ", "Telemediengesetz ", "(TMG) ", "§7 ", "(1) ", "sind ", "wir ", 
  "als ", "Diensteanbieter ", "für ", "eigene ", "Informationen, ", "die ", "wir ", "zur ", "Nutzung ", "bereitstellen, ", "nach ", 
  "den ", "allgemeinen ", "Gesetzen ", "verantwortlich. ", "Leider ", "können ", "wir ", "keine ", "Haftung ", "für ", "die ", 
  "Korrektheit ", "aller ", "Inhalte ", "auf ", "dieser ", "Webseite ", "übernehmen, ", "speziell ", "für ", "jene ", "die ", 
  "seitens ", "Dritter ", "bereitgestellt ", "wurden. ", "Als ", "Diensteanbieter ", "im ", "Sinne ", "der ", "§§ ", "8 ", "bis ", 
  "10 ", "sind ", "wir ", "nicht ", "verpflichtet, ", "die ", "von ", "ihnen ", "übermittelten ", "oder ", "gespeicherten ", 
  ...
  "behördlichen ", "Anordnungen ", "bleiben ", "auch ", "im ", "Falle ", "unserer ", "Nichtverantwortlichkeit ", "nach ", "den ", 
  "§§ ", "8 ", "bis ", "10 ", "unberührt. ", "\n",
  "Sollten ", "Ihnen ", "problematische ", "oder ", "rechtswidrige ", "Inhalte ", "auffallen, ", "bitte ", "wir ", "Sie ", "uns ", 
  ...
  "keine ", "Kenntnis ", "rechtswidriger ", "Tätigkeiten ", "hatten ", "und ", "haben, ", "uns ", "solche ", "Rechtswidrigkeiten ", 
  "auch ", "bisher ", "nicht ", "aufgefallen ", "sind ", "und ", "wir ", "Links ", "sofort ", "entfernen ", "würden, ", "wenn ", 
  ...
  "Datenschutz ",
  "Wir ", "haben ", "diese ", "Datenschutzerklärung ", "(Fassung ", "20.02.2021-321264227) ", "verfasst, ", "um ", "Ihnen ", "gemäß ", 
  "der ", "Vorgaben ", "der Datenschutz-Grundverordnung ", "(EU) ", "2016/679 zu ", "erklären, ", "welche ", "Informationen ", "wir ", 
  "sammeln, ", "wie ", "wir ", "Daten ", "verwenden ", "und ", "welche ", "Entscheidungsmöglichkeiten ", "Sie ", "als ", "Besucher ", 
  "dieser ", "Webseite ", "haben. ", "\n",
  "Datenschutzerklärungen ", "klingen ", "für ", "gewöhnlich ", "sehr ", "technisch. ", "Diese ", "Version ", "soll ", "Ihnen ", 
  "hingegen ", "die ", "wichtigsten ", "Dinge ", "so ", "einfach ", "und ", "klar ", "wie ", "möglich ", "beschreiben. ", "Soweit ", 
  "es ", "möglich ", "ist, ", "werden ", "technische ", "Begriffe ", "leserfreundlich ", "erklärt. ", "Außerdem ", "möchten ", "wir ", 
  "vermitteln, ", "dass ", "wir ", "mit ", "dieser ", "Website ", "nur ", "dann ", "Informationen ", "sammeln ", "und ", "verwenden, ", 
  "wenn ", "eine ", "entsprechende ", "gesetzliche ", "Grundlage ", "gegeben ", "ist. ", "Das ", "ist ", "sicher ", "nicht ", "möglich, ", 
  "wenn ", "man ", "möglichst ", "knappe, ", "technische ", "Erklärungen ", "abgibt, ", "so ", "wie ", "sie ", "im ", "Internet ", "oft ", 
  "Standard ", "sind, ", "wenn ", "es ", "um ", "Datenschutz ", "geht. ", "Ich ", "hoffe ", "Sie ", "finden ", "die ", "folgenden ", 
  "Erläuterungen ", "interessant ", "und ", "informativ ", "und ", "vielleicht ", "ist ", "die ", "eine ", "oder ", "andere ", 
  "Information ", "dabei, ", "die ", "Sie ", "noch ", "nicht ", "kannten. ", "\n",
  "Wenn ", "trotzdem ", "Fragen ", "bleiben, ", "möchten ", "wir ", "Sie ", "bitten ", "den ", "vorhandenen ", "Links ", "zu ", "folgen ", 
  "und ", "sich ", "weitere ", "Informationen ", "auf ", "Drittseiten ", "anzusehen, ", "oder ", "uns ", "einfach ", "eine ", "E-Mail ", 
  "zu ", "schreiben. ", "Unsere ", "Kontaktdaten ", "finden ", "Sie ", "im ", "Impressum. ", "\n", "\n",
  "Quelle: ", "Erstellt mit ", "dem Datenschutz ", "Generator von ", "AdSimple in ", "Kooperation ", "mit bauenwir.de ", "\n", "\n",
  "Datenschutzerklärung ", "für ", "die ", "Nutzung ", "von ", "Adobe ", "Fonts ", "\n", "\n",
  "Wir ", "nutzen ", "für ", "die ", "Schriftdarstellung ", "den ", "Service ", "der ", "Firma ", "Adobe ", "Fonts. ", "Beim ", "Aufruf ", 
  "unserer ", "Seite ", "wird ", "Ihre ", "IP ", "und ", "weitere ", "technische ", "Daten ", "an ", "Adobe ", "Fonts ", "übertragen. ", 
  "Adobe ", "Fonts ", "nutzt ", "die ", "Daten ", "nur ", "zur ", "Visualisierung ", "der ", "Schriftarten ", "und ", "Analyse ", "derer ", 
  "Popularität.  ", "\n", "\n",
  ...
  "Francisco, ", "CA ", "94107, ", "USA ", "gehostet. ", "Beachten ", "Sie ", "daher ", "auch ", "die GitHub ", "Privacy ", "Policy. "
];
let imprintLines = [[]];
let leftEdge;
